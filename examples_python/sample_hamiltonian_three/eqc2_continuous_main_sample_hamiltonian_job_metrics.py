...
# 1) Get the Hamiltonian data file
...
params_vec["solution_type"] = "continuous"
...
if job_submit_response_json['job_info']['details']['status'] == "COMPLETED":
    ...
    print(job_submit_response_json['job_info']['metrics']['provider']['qphoton']['time_ns']['wall']['dirac_2_controller']['total'])
