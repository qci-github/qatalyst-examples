...
if job_submit_response_json['job_info']['details']['status'] == "COMPLETED":
    ...
    print(job_submit_response_json['job_info']['metrics']['provider']['qphoton']['time_ns']['wall']['dirac_1_controller']['total'])
    print(job_submit_response_json['job_info']['metrics']['provider']['qphoton']['time_ns']['wall']['dirac_1_device']['total'])
